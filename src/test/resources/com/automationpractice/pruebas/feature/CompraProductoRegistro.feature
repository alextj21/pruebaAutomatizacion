...
Característica: realizar compra de producto Registro
  ...
  Esquema del escenario: compra registro producto exitoso
    ...
    Entonces valido que aparezca la aprobacion de la compra
      ...
      |<validar>|
    Ejemplos: 
      | correo                | nombre    | apellido | contraseña | dia | mes     | año  | empresa | direccion | direccion2 | ciudad       | estado  | codigoPostal | informacion | telefono | telefonoMovil | validar                             |
      | alex_xo27yy@gmail.com | alejandro | roldan   |     123456 |   2 |January  | 2021 | prueba  | cra 24    | cra 33     | BARRANQUILLA | Alabama |        11011 | prueba      |  2563214 |   31024569874 | Your order on My Store is complete. |
